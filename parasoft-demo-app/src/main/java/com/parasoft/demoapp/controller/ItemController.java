...
@Controller
@RequestMapping({"/v1/assets/items", "/proxy/v1/assets/items"})
public class ItemController {
	@Autowired
	private ItemService itemService;

	@Operation(description = "Obtain all items under current conditions.")
	@ApiResponse(responseCode = "200", description = "Return all items under current conditions.")
	...
	@ApiResponse(responseCode = "200", description = "Return item with corresponding id.")
	...
	@ApiResponse(responseCode = "200", description = "Return item with corresponding name.")
	@ApiResponse(responseCode = "400", description = "Invalid request parameter.",
	content = {@Content(schema = @Schema(hidden = true))})
	...
	@ApiResponse(responseCode = "200", description = "Create a new item in this category successfully.")
    @ApiResponse(responseCode = "400", description = "Invalid request payload.",
    content = {@Content(schema = @Schema(hidden = true))})
	@ApiResponse(responseCode = "403", description = "The user does not have permission to add a new item.",
				 content = {@Content(schema = @Schema(hidden = true)) })
	...
	@ApiResponse(responseCode = "200", description = "Delete item with corresponding id successfully.")
    @ApiResponse(responseCode = "400", description = "Invalid request parameter.",
    content = {@Content(schema = @Schema(hidden = true))})
	@ApiResponse(responseCode = "403", description = "The user does not have permission to delete the item.",
				 content = {@Content(schema = @Schema(hidden = true)) })
	@ApiResponse(responseCode = "404", description = "No item with corresponding item id.",
				 content = {@Content(schema = @Schema(hidden = true)) })
	...
	@ApiResponse(responseCode = "200", description = "Delete item with corresponding name successfully.")
	@ApiResponse(responseCode = "400", description = "Invalid request parameter.",
			content = {@Content(schema = @Schema(hidden = true))})
	@ApiResponse(responseCode = "403", description = "The user does not have permission to delete the item.",
			content = {@Content(schema = @Schema(hidden = true)) })
