...
@Controller
@RequestMapping({"/v1/assets", "/proxy/v1/assets"})
public class CategoryController {
    ...
    @ApiResponse(responseCode = "200", description = "Return category with corresponding id.")
    ...
    @ApiResponse(responseCode = "200", description = "Return category with corresponding name.")
    @ApiResponse(responseCode = "400", description = "Invalid request parameter.",
                content = {@Content(schema = @Schema(hidden = true))})
    ...
    @Operation(description = "Obtain all categories under current conditions.")
    @ApiResponse(responseCode = "200", description = "Return all categories under current conditions.")
    ...
    @ApiResponse(responseCode = "200", description = "Create a new category successfully.")
    @ApiResponse(responseCode = "400", description = "Invalid request payload.",
                 content = {@Content(schema = @Schema(hidden = true))})
    @ApiResponse(responseCode = "403",
                 description = "The user does not have permission to add a new category.",
                 content = {@Content(schema = @Schema(hidden = true))})
    ...
    @ApiResponse(responseCode = "400", description = "Invalid request payload.",
                 content = {@Content(schema = @Schema(hidden = true))})
    @ApiResponse(responseCode = "403",
                 description = "The user does not have permission to update the category.",
                 content = {@Content(schema = @Schema(hidden = true))})
    @ApiResponse(responseCode = "404", description = "No category with corresponding id.",
                 content = {@Content(schema = @Schema(hidden = true))})
    ...
    @ApiResponse(responseCode = "200", description = "Delete category with corresponding id successfully.")
    @ApiResponse(responseCode = "400", description = "Invalid request parameter.",
                 content = {@Content(schema = @Schema(hidden = true))})
    @ApiResponse(responseCode = "403",
                 description = "The user does not have permission to delete the category.",
                 content = {@Content(schema = @Schema(hidden = true))})
    @ApiResponse(responseCode = "404", description = "No category with corresponding id.",
                 content = {@Content(schema = @Schema(hidden = true))})
