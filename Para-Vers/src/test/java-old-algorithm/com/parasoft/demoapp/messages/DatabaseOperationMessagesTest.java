...
/**
 * Parasoft Jtest UTA: Test class for DatabaseOperationMessages
 *
 * @author jakubiak
 * @see DatabaseOperationMessages
 */
public class DatabaseOperationMessagesTest {
    /**
    ...
    public void testGetString() throws Throwable {
        // Given
        DatabaseOperationMessages underTest = new DatabaseOperationMessages();
