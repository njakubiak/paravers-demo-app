...
/**
 * Parasoft Jtest UTA: Test class for GlobalPreferencesMessages
 *
 * @author jakubiak
 * @see GlobalPreferencesMessages
 */
public class GlobalPreferencesMessagesTest {
    /**
    ...
    public void testGetString() throws Throwable {
        // Given
        GlobalPreferencesMessages underTest = new GlobalPreferencesMessages();
